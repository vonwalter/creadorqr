...
st.image("images/supports.JPG", use_container_width=True)
...
st.write("Paso a paso de esta app para crear codigo QR y descargarlo.")
st.write("1.-  Ingrese la Dirección de la web donde esta el archivo o la carpeta a compartir(url).")
st.write("2.-  Puede agregar una imagen (opcional, solo si lo desea) al QR, puede arrastrar la imagen;")
st.write("   o puede realizar un Browse(busqueda del archivo en el disco.")
st.write("3.-  Click en genear codigo QR, creará la imagen del QR solicitado ")
st.write("4.-  Al fondo de la pantalla aparecerá un botón Descargar QR, que le permitirá descargar el archivo.")
